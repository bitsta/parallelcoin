...
#ifndef H_POCKETCHANGE_SCRIPT
#define H_POCKETCHANGE_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CPocketChangeAddress
 */
...
public:
    ...
    // Pre-version-0.6, PocketChange always counted CHECKMULTISIGs
