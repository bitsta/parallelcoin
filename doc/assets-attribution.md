The following is a list of assets used in the pocketchange source and their proper attribution.
...
### Info
* Designer: md2k7
* Site: https://pocketchangetalk.org/index.php?topic=15276.0
...
### Info
* Designer: Jonas Schnelli (based on the original pocketchange logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/pocketchange.icns, src/qt/res/src/pocketchange.svg,
	src/qt/res/src/pocketchange.ico, src/qt/res/src/pocketchange.png,
	src/qt/res/src/pocketchange_testnet.png, docs/pocketchange_logo_doxygen.png,
