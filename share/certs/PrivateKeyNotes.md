...
unlocked to sign the PocketChange-Qt.app bundle.
...
allowing somebody to distribute a PocketChange-Qt.app or pocketchange-qt-setup.exe with a valid
...
that the pocketchange-qt.exe file inside the installer had not been tampered with.
