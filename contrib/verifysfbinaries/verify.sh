...
WORKINGDIR="/tmp/pocketchange"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="http://downloads.sourceforge.net/project/pocketchange/PocketChange/pocketchange-0.8.2/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/pocketchange/PocketChange/"
VERSIONPREFIX="pocketchange-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'pocketchange-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[pocketchange-]<version>-[rc[0-9]] (example: pocketchange-0.7.1-rc1)"
   echo "wget output:"
